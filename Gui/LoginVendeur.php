...
<div class="container-sm col-4">
    <form method="post" action="LoginVendeur.php">
        ...
        <div class="mb-3">
         ...
         <center>
        <button type="submit" name="connection" value="connection" class="btn btn-primary">Submit</button>
         Vous n'avez pas de compte ?<br> <a href="./inscriptionVendeur.php">Inscrivez-vous</a>
         </center>
    </form>
</div>
<?php
if(!empty($_POST['connection']))
{
    ...
    $r=Vendeur::GetVendeur($mail,$password);
    if($r==0)
    {
        ...
        session_start();
        $_SESSION['slog']= $mail;
        header("location:./DashboardVendeur");
